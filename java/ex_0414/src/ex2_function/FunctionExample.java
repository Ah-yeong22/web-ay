...
public class FunctionExample {
	public static void main(String[] args) {
        ...
        Function<String, String> pipeline =
                removeSpace.andThen(toLower).andThen(addPrefix);

        // 실행
        String result4 = pipeline.apply(input);
