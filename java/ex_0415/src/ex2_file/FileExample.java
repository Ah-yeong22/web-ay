...
public class FileExample {
	public static void main(String[] args) {
		//메모장까지의 경로 
		String path = "C:\\Users\\adminn\\Desktop\\web-ay\\test.txt";
		...
		//상대경로는 편하지만, 프로그램을 어디서 실행하느냐에 따라 기준위치가 달라질 수 있음.
		...
		File f2 = new File("새로운 테스트 파일.txt");
		try {
		...
		//폴더는 내부가 비어있어야 삭제 가능
		//안에 파일이 있는 폴더는 바로 삭제 가능
		
		//list()
		//이름 목록을 문자열 배열로 반환한다. 
		//목표 폴더의 바로밑에 있는 폴더와 파일만 반환
//		dir = new File("C:\Users\adminn\Desktop\web-ay");
